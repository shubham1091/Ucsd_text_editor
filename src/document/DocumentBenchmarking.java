...
public class DocumentBenchmarking {
	...
	public static void main(String[] args) {
		...
		System.out.println("NumberOfChars\tBasicTime\tEfficentTime");
		for (int numToCheck = start; numToCheck < numSteps * increment + start; numToCheck += increment) {
			...
			System.err.print((ed - st) / 1000000 + "\t");

			st = System.nanoTime();
			for (int i = 0; i < trials; i++) {
				EfficientDocument doc = new EfficientDocument(str);
				doc.getFleschScore();
			}
			ed = System.nanoTime();

			System.err.println((ed - st) / 1000000);
